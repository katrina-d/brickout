...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(480, 480, "Katrina Duys", NULL, NULL);
	if (!window) {
		glfwTerminate();
		exit(EXIT_FAILURE);
	}
	...
	Brick brick4(REFLECTIVE, 0, 0, 0.2, 1, 0.0, 0.0);
	Brick brick5(DESTRUCTABLE, -0.9, 0.9, 0.2, 0.58, 0.0, 0.827);
	Brick brick6(REFLECTIVE, 0.9, 0.9, 0.2, 0.0, 0.0, 1.0);
	Brick brick7(DESTRUCTABLE, 0.5, 0.33, 0.2, 1.0, 0.0, 1.0);
